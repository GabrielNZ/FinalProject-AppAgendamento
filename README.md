...
Antes de começar a minha história universitária, eu tinha o desejo de aplicar tudo que eu aprendi em um projeto grande. Aqui está! 
...
Cliente -> Solicita agendamento nos horários disponíveis.
...
### Front end
- Mesmo com esse 1 ano e meio de estudos, não consegui adquirir conhecimento suficiente para usar um framework no front-end, por isso decidi aplicar apenas o que eu sabia (HTML, CSS & JS).
